...
const navItems: NavItem[] = [
  { label: "Dashboard", href: "/salvavidas/admin", icon: LayoutDashboard },
  { label: "Casos", href: "/salvavidas/admin/casos", icon: Heart },
  { label: "Usuários", href: "/salvavidas/admin/usuarios", icon: Users },
  { label: "Relatórios", href: "/salvavidas/admin/relatorios", icon: FileText },
];
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: space.md }}>
          ...
          >
            <Heart size={fontSizes.xl} color={colors.white} />
          </div>
          <div>
