...
const navItems: NavItem[] = [
  { label: "Dashboard", href: "/profissionais/admin", icon: LayoutDashboard },
  { label: "Profissionais", href: "/profissionais/admin/profissionais", icon: Briefcase },
  { label: "Avaliações", href: "/profissionais/admin/avaliacoes", icon: Star },
  { label: "Relatórios", href: "/profissionais/admin/relatorios", icon: FileText },
];
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: space.md }}>
          ...
          >
            <Briefcase size={fontSizes.xl} color={colors.white} />
          </div>
          <div>
