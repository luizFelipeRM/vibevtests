...
const reports = [
  {
    ...
    description: "Relatório completo de usuários ativos no último mês",
    icon: BarChart3,
  ...
  {
    title: "Alimentos Mais Usados",
    description: "Ranking dos alimentos mais adicionados pelos usuários",
    icon: TrendingUp,
  ...
  {
    title: "Logs Nutricionais",
    description: "Histórico completo de logs de macronutrientes registrados",
    icon: FileText,
  ...
  },
  {
    ...
    description: "Dados demográficos e perfis de configuração dos usuários",
    icon: BarChart3,
    color: colors.piecharts.purple,
    period: "Cadastros completos",
    records: 892,
  },
];

const stats = [
  { label: "Total de Logs", value: "15.234", change: "+12.5%" },
  { label: "Média por Usuário", value: "12.2", change: "+3.1%" },
  { label: "Taxa de Conclusão", value: "68%", change: "+8.4%" },
  { label: "Engajamento Diário", value: "342", change: "-2.3%" },
];
