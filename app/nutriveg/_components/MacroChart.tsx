  ...
  return (
    <div style={{ position: "relative", width: 280, height: 280, margin: "0 auto" }}>
      ...
      >
        ...
        <div style={{ fontSize: 32, fontWeight: fontWeights.black, color: colors.text_primary }}>
          {totalGrams}g
        </div>
        <div style={{ fontSize: fontSizes.sm, color: colors.text_secondary }}>macros</div>
      </div>
    </div>
  );
};
